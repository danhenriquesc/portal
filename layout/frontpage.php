...
<body id="<?php p($PAGE->bodyid) ?>" class="<?php p($PAGE->bodyclasses.' '.join(' ', $bodyclasses)) ?>">
    ...
    <?php 
        echo $OUTPUT->slider('frontpage'); 
        echo $OUTPUT->introduction($CFG);
        echo $OUTPUT->featuredcourses($CFG);
        echo $OUTPUT->linkbox($CFG);
        echo $OUTPUT->imagewithtext($CFG);
        echo $OUTPUT->html_blocks($CFG);
        echo $OUTPUT->buttonbar($CFG);
    ?>
...
<?php 
    ...
    //$PAGE->requires->js('/theme/portal/javascript/portalslideshow.js');
